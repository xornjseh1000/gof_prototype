...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <span  style="color: red;font-size:20px;text-align=right">로그아웃</span> 
 <br />
 <br />
 	
<span style="color: black;font-size:30px;text-align=left">결제정보입력</span>
	...
	<form action="${context}/member.do" method="get">
		<input type="text" name="카드번호" value="카드번호">
			...
			&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;
			<select <option value="유효기간(월)">유효기간(월)</option>
...
<select> <option value="유효기간(년)">유효기간(년)</option>
  ...
  <option value="2018">2018</option>
   <option value="2017">2017</option>
	...
	<input type="radio" name="국민" value="Kuk" > 
	<span>국민</span>

	<input type="radio" name="하나" value="Han" > 
	<span>하나</span>

	<input type="radio" name="신한"  value="Sin" > 
	<span>신한</span>
		
	
		<br />	
	<input type="text" name="이름" value="이름"> 
	&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
...
<br />
	...
	<input type="radio" name="Special"  value="Special" > 
	<span>특별회원</span>

   <br> 
		
		<input
			type="text" name="연락처" value="연락처">
			
			<br />	<br /> <br />
			<input type="checkbox" id="myCheck" onmouseover="myFunction()"
				onclick="alert('click event occured')"> 이용약관/개인정보취급방침동의 &nbsp;&nbsp;&nbsp;Netflix이용약관
				<br />
				 
				<input type="checkbox" id="myCheck" onmouseover="myFunction()"
				onclick="alert('click event occured')"> 개인정보 제3자제공 동의 &nbsp;&nbsp;&nbsp;개인정보취급방침
				<br>
				
				<input type="checkbox" id="myCheck" onmouseover="myFunction()"
				onclick="alert('click event occured')"> 정보의 해외이전동의 &nbsp;&nbsp;&nbsp;
				<br>
